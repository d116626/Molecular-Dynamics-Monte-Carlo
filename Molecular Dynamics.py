...
def compute_next_event(pos, vel):
    ...
    pair_times = [pair_time(pos[k], vel[k], pos[l], vel[l], sigma)
                  for k, l in pairs]
...
def compute_new_velocities(pos, vel, next_event_arg):
    if next_event_arg < len(singles):
        ...
        abs_x = numpy.float32(math.sqrt(del_x[0] ** 2 + del_x[1] ** 2))
        e_perp = numpy.float32([c / abs_x for c in del_x])
...
vel = [[0.25, 0.5], [0.8, 0.18], [-0.7, -0.79], [0.78, 0.1177]]
singles = [(0, 0), (0, 1), (1, 0), (1, 1), (2, 0), (2, 1), (3, 0), (3, 1)]
pairs = [(0, 1), (0, 2), (0, 3), (1, 2), (1, 3), (2, 3)]
sigma = 0.18
t = 0.0
dt = 0.02     # time to events
n_steps = 1000
